  ...
  return (
    <div className="flex flex-col justify-center items-center p-4 w-screen min-h-screen bg-gradient-to-br transition-colors from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950">
      ...
      <div className="flex flex-col items-center mx-auto max-w-4xl text-center">
        <div className="mb-8">
          <h1 className="mb-6 text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 dark:from-blue-400 dark:via-purple-400 dark:to-indigo-400 sm:text-6xl lg:text-7xl">
            Welcome to Lingez
          </h1>
        ...
        <div className="flex flex-col gap-4 mt-8 sm:flex-row sm:gap-6">
          <button
            ...
            className="relative px-8 py-4 font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl shadow-lg transition-all duration-300 transform group hover:from-blue-700 hover:to-blue-800 dark:from-blue-500 dark:to-blue-600 dark:hover:from-blue-600 dark:hover:to-blue-700 hover:scale-105 hover:shadow-xl"
          >
          ...
          <button
            ...
            className="relative px-8 py-4 font-semibold text-white bg-gradient-to-r from-emerald-600 to-emerald-700 rounded-2xl shadow-lg transition-all duration-300 transform group hover:from-emerald-700 hover:to-emerald-800 dark:from-emerald-500 dark:to-emerald-600 dark:hover:from-emerald-600 dark:hover:to-emerald-700 hover:scale-105 hover:shadow-xl"
          >
